        ...
        <div class="container">
            <div class="card border-0 shadow">
                ...
                <div class="card-body" style="margin-bottom:100px">
                    <form action="/dashboard/data/room/{{ $room->no }}/store-image" method="POST"
                                                        ...
                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title me-auto">Image #{{
                                                                        $loop->iteration }}</h5>
                                                                    <div>
                                                                        <a href="/dashboard/data/room/26D/image/{{ $c->id }}/delete"
                            ...
                            <div class="col-lg-5 col-12 order-1 order-md-2 col-md-5">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" disabled value="{{ $room->id }}"
                                            id="room_id" placeholder="ex 10A">
                                    </div>
