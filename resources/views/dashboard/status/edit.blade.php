                        ...
                        <form action="/dashboard/data/status/{{ $status->id }}/update" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" value="{{ $status->name }}" id="name"
                                        name="name" placeholder="Vacant">
                                </div>
                                <div class="col-md-5">
                                    <label for="code" class="form-label"> Code <span
                                            style="font-style: italic;">(required)</span> </label>
                                    <input type="text" class="form-control" value="{{ $status->code }}" id="code"
                                        name="code" placeholder="V">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10 mt-3">
                                    <label for="info" class="form-label"> Description <span
                                            style="font-style: italic;">(required)</span></label>
                                    <textarea placeholder="Sebutan bagi kamar yang kosong" name="info" id="info"
                                        rows="3" class="form-control">{{ $status->info }}</textarea>
                                </div>
                            </div>
