...
<body>
    ...
    <div class="container">
        <div class="img">
            <img src="/loginn/img/bg.svg" alt="Background Image">
        </div>
        <div class="login-content">
            <form action="/login" method="post">
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <input type="text" name="username" id="username" required autofocus @if(Cookie::has('username'))
                            value="{{ Cookie::get('username') }}" @endif class="input" placeholder="Username">
                    </div>
                </div>
                <div class="input-div pass">
                    ...
                    <div class="div">
                        <input type="password" name="password" id="password" required class="input"
                            placeholder="Password" @if(Cookie::has('password')) value="{{ Cookie::get('password') }}"
                            @endif>
                    </div>
                </div>
